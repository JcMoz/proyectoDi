                    ...
                    <table class="table table-bordered table table-active">
                        ...
                        <tbody>
                            ...
                            <?php
                              ...
                              $sacar = mysqli_query($conexion, "SELECT*FROM grado WHERE turno_grado=1");  
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div aling="center">
                                            ...
                                            <a href="../reportes/Mi_horario.php?ir=<?php echo $graVer; ?>" class="btn"> 
                            ...
                            <tr>
                                <td class="text-center">
                                     <div aling="center">
                                         ...
                                         <a href="../reportes/re_horario.php" class="btn"> 
                                                <button class="btn btn-outline-warning">Quinto-Noveno</button>
                                            </a>
