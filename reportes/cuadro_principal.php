...
<div class="content-wrapper">
    <div align="right">
        <img  name="edit" data-toggle="modal" data-target="#modalayudaNotasPorGrado" data-html="true" title="Ayuda"  src="../imagenes/ayu.ico" width="35" height="35">
       <?php include_once '../ayuda/ayudaNotasPorGrado.php'; ?>
    </div>
                ...
                <div class="panel-body">
                    <table class="table table-bordered table table-active">
                        ...
                        <th class="text-center">
                            <div align="center">
                                <font face="Arial Narrow" size="5" color="#001f4d">Reporte de cuadro de notas por grado</font>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div aling="center">
                                            ...
                                            <a href="../reportes/cuadro_materia.php?ir=<?php echo $graVer; ?>" class="btn"> 
