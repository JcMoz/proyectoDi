                ...
                <div class="row">             
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="panel-body">
                            ...
                            <br>
                            <?php
                            $padreE = mysqli_query($conexion, "SELECT*FROM padre WHERE id_alumno='$antiguo'");
                            while ($pR = mysqli_fetch_array($padreE)) {
                                $enP = $pR['encargado'];
                            }
                            $maE = mysqli_query($conexion, "SELECT*FROM madre WHERE id_alumno='$antiguo'");
                            while ($mR = mysqli_fetch_array($maE)) {
                                $enM = $mR['encargado'];
                            }
                            ...
                            if ($enP == 1) {
                                ...
                                <div class="text-center">
                                    El padre es el encargado<br/>
                                  
                                    <input type="button" value="Finalizar" name="cancel" class=" btn btn-cancelar" onclick="location = '/proyectoDi/doc/principal.php'" >
                                    <br/>
                                </div>
                                <?php
                            } else {
                                if ($enM == 1) {
                                    ...
                                    <div class="text-center">
                                        La Madre es la encargada<br/>
                                    <input type="button" value="Finalizar" name="cancel" class=" btn btn-cancelar" onclick="location = '/proyectoDi/inscripcion/buscarAlumno.php'" >
                                    <br/>
                                    </div>
                                    <?php
                                }else{
