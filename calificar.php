...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <div align="center">
            <font face="Arial Narrow" size="5" color="#001f4d">Calificar</font>
            <img src="imagenes/cali.ico" width="70" height="70">
        </div>
        ...
        <div align="center">
            <input type="submit" style="color:white" value="Atras" name="atras" class="btn btn-warning" onclick="location='/proyectoDi/registrarNotas.php'">
        </div>
