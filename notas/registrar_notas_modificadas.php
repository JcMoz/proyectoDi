...
$extraer_id = mysqli_query($conexion, "SELECT*FROM actividades LEFT JOIN asignacion_a_g ON actividades.id_asignacion_a_g=asignacion_a_g.id_asignacion WHERE id_gra='$grado' AND id_materia='$materia' AND estado_a='procesado' AND periodo='$periodo'");
...
$notas=  mysqli_query($conexion,"SELECT*FROM notas_2 WHERE id_inscripcion='$alumno' AND id_materia='$materia' AND id_grado='$grado' AND periodo='$pe' AND estado_n='procesado'");
...
//*************fin de extraer datos
            ?>
            <div align="center">
                <font face="Arial Narrow" size="5" color="#001f4d">Modificar notas</font>
                <img src="../imagenes/modificarCali.png" width="80" height="80"><br/>
...
if (isset($_REQUEST['tirar'])) {
    ...
    echo '<script>swal({
                ...
                function () {
                    location.href="ModificarNotas.php";
