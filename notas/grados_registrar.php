...
<div class="content-wrapper">
     <div align="right">
        <img  name="edit" data-toggle="modal" data-target="#modalayudaIngresoActividades1" data-html="true" title="Ayuda"  src="../imagenes/ayu.ico" width="35" height="35">
        <?php include_once '../ayuda/ayudaIngresoActividades1.php'; ?>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div aling="center">
                                            ...
                                            <a href="../notas/act_materias.php?ir=<?php echo $registrar;?>" class="btn"> 
